...
(function(){
  ...
  // SPREAD: evenly spaced initial positions (stage width=1260)
  var SP = {
    headset:  { l:  15, b: 50 },
    mic:      { l: 218, b:  0 },
    keyboard: { l: 328, b:  0 },
  ...
  // ASSEMBLED positions — fixed:
  // Monitor: centered at stage center (1260/2=630), monitor width=380 → left = 630 - 190 = 440
  // Keyboard: width=320, center it under monitor → left = 630 - 160 = 470, but nudge right slightly for visual balance → 460
  // Add ~30px gap below monitor (monitor bottom at ~370+8=378, keyboard sits at b:8 so gap is handled by bottom values)
  // Mouse: to the right of keyboard (460 + 320 + 20 = 800)
  // Tower: far right
  // Headset: left side
  // Mic: close to headset, reduced gap (was 190 now ~310 to be closer to headset at 70+200=270)

  var AS = {
    monitor:  { l: 440, b: 180 },   // centered (440 + 190 = 630 center), raised higher
    keyboard: { l: 460, b:   8 },   // centered under monitor, larger gap from monitor
    mouse:    { l: 800, b:   8 },   // right of keyboard
    tower:    { l: 960, b:   5 },   // far right
    headset:  { l: 220, b: 220 },   // closer to monitor — center at 220+100=320
    mic:      { l: 276, b:  10 },   // same horizontal center as headset (276+44=320), below headset
  };
    ...
    <div id="stage" style="position:relative;width:945px;height:375px;margin:0 auto;">
      ...
      <div id="w-headset" style="position:absolute;display:flex;flex-direction:column;align-items:center;transition:left .75s cubic-bezier(.65,0,.35,1),bottom .75s cubic-bezier(.65,0,.35,1);">
        <svg id="v-headset" width="139" height="165" viewBox="0 0 180 225" style="transition:width .75s cubic-bezier(.65,0,.35,1),height .75s cubic-bezier(.65,0,.35,1);overflow:visible;)">
          <defs>
            ...
            <linearGradient id="hband" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#2a2a2a"/><stop offset="100%" stop-color="#444"/></linearGradient>
          </defs>
          <path d="M28,135 Q28,14 90,14 Q152,14 152,135" fill="none" stroke="#0a0a0a" stroke-width="26" stroke-linecap="round"/>
          <path d="M28,135 Q28,14 90,14 Q152,14 152,135" fill="none" stroke="url(#hband)" stroke-width="18" stroke-linecap="round"/>
          <path d="M28,135 Q28,14 90,14 Q152,14 152,135" fill="none" stroke="#555" stroke-width="8" stroke-linecap="round"/>
          <path d="M62,38 Q90,24 118,38" fill="none" stroke="#444" stroke-width="13" stroke-linecap="round"/>
          <ellipse cx="20" cy="142" rx="30" ry="37" fill="#0a0a0a"/>
          <ellipse cx="20" cy="142" rx="27" ry="34" fill="url(#hcup)"/>
          <ellipse cx="20" cy="142" rx="27" ry="34" fill="none" stroke="url(#hring)" stroke-width="4.5" opacity=".98"/>
          <ellipse cx="20" cy="142" rx="16" ry="20" fill="#111"/>
          <circle  cx="20" cy="142" r="9"  fill="#222"/>
          <circle  cx="20" cy="142" r="5"  fill="#333"/>
          <ellipse cx="160" cy="142" rx="30" ry="37" fill="#0a0a0a"/>
          <ellipse cx="160" cy="142" rx="27" ry="34" fill="url(#hcup)"/>
          <ellipse cx="160" cy="142" rx="27" ry="34" fill="none" stroke="url(#hring)" stroke-width="4.5" opacity=".98"/>
          <ellipse cx="160" cy="142" rx="16" ry="20" fill="#111"/>
          <circle  cx="160" cy="142" r="9"  fill="#222"/>
          <circle  cx="160" cy="142" r="5"  fill="#333"/>
          <path d="M20,172 Q6,202 14,215" fill="none" stroke="#222" stroke-width="6" stroke-linecap="round"/>
          <rect x="7" y="208" width="16" height="13" rx="6.5" fill="#1a1a1a"/>
        </svg>
        <span class="lbl" style="color:rgba(0,0,0,.35);font-size:9.5px;font-weight:700;letter-spacing:2.5px;text-transform:uppercase;margin-top:12px;transition:opacity .35s;white-space:nowrap;">HEADSET</span>
      </div>
      ...
      <div id="w-mic" style="position:absolute;display:flex;flex-direction:column;align-items:center;transition:left .75s cubic-bezier(.65,0,.35,1),bottom .75s cubic-bezier(.65,0,.35,1);">
        <svg id="v-mic" width="71" height="161" viewBox="0 0 95 218" style="transition:width .75s cubic-bezier(.65,0,.35,1),height .75s cubic-bezier(.65,0,.35,1);overflow:visible;)">
          ...
          <ellipse cx="47" cy="210" rx="36" ry="8" fill="#1a1a1a"/>
          <rect x="38" y="178" width="19" height="35" rx="5" fill="url(#mbase)"/>
          <ellipse cx="47" cy="178" rx="20" ry="6" fill="#333"/>
          <rect x="44" y="133" width="7" height="48" fill="#2a2a2a"/>
          <rect x="44" y="151" width="7" height="9" rx="2" fill="#fff" opacity=".6"/>
          <rect x="14" y="35" width="67" height="100" rx="33" fill="url(#mbody)" stroke="#fff" stroke-width="2"/>
          <ellipse cx="47" cy="37" rx="33" ry="11" fill="#222"/>
          ...
          <rect x="14" y="35" width="67" height="100" rx="33" fill="none" stroke="#aaa" stroke-width="2.5" stroke-dasharray="11 6" opacity=".5"/>
        </svg>
        <span class="lbl" style="color:rgba(0,0,0,.35);font-size:9.5px;font-weight:700;letter-spacing:2.5px;text-transform:uppercase;margin-top:12px;transition:opacity .35s;white-space:nowrap;">MICROPHONE</span>
      </div>
      ...
      <div id="w-keyboard" style="position:absolute;display:flex;flex-direction:column;align-items:center;z-index:2;transition:left .75s cubic-bezier(.65,0,.35,1),bottom .75s cubic-bezier(.65,0,.35,1);">
        <svg id="v-keyboard" width="225" height="98" viewBox="0 0 300 130" style="transition:width .75s cubic-bezier(.65,0,.35,1),height .75s cubic-bezier(.65,0,.35,1);overflow:visible;)">
          ...
          <rect x="1" y="5" width="298" height="117" rx="12" fill="url(#kbbg)" stroke="#333" stroke-width="1.5"/>
          <rect x="1" y="115" width="298" height="7" rx="4" fill="url(#kbedge)" opacity=".5"/>
          <g fill="#1e1e1e" stroke="#333" stroke-width="1">
            <rect x="9" y="13" width="18" height="16" rx="4"/><rect x="30" y="13" width="18" height="16" rx="4"/><rect x="51" y="13" width="18" height="16" rx="4"/><rect x="72" y="13" width="18" height="16" rx="4"/><rect x="93" y="13" width="18" height="16" rx="4"/><rect x="114" y="13" width="18" height="16" rx="4"/><rect x="135" y="13" width="18" height="16" rx="4"/><rect x="156" y="13" width="18" height="16" rx="4"/><rect x="177" y="13" width="18" height="16" rx="4"/><rect x="198" y="13" width="18" height="16" rx="4"/><rect x="219" y="13" width="18" height="16" rx="4"/><rect x="240" y="13" width="18" height="16" rx="4"/><rect x="261" y="13" width="29" height="16" rx="4"/>
            <rect x="9" y="33" width="27" height="16" rx="4"/><rect x="39" y="33" width="18" height="16" rx="4"/><rect x="60" y="33" width="18" height="16" rx="4"/><rect x="81" y="33" width="18" height="16" rx="4"/><rect x="102" y="33" width="18" height="16" rx="4"/><rect x="123" y="33" width="18" height="16" rx="4"/><rect x="144" y="33" width="18" height="16" rx="4"/><rect x="165" y="33" width="18" height="16" rx="4"/><rect x="186" y="33" width="18" height="16" rx="4"/><rect x="207" y="33" width="18" height="16" rx="4"/><rect x="228" y="33" width="18" height="16" rx="4"/><rect x="249" y="33" width="41" height="16" rx="4"/>
            <rect x="9" y="53" width="34" height="16" rx="4"/><rect x="46" y="53" width="18" height="16" rx="4"/><rect x="67" y="53" width="18" height="16" rx="4"/><rect x="88" y="53" width="18" height="16" rx="4"/><rect x="109" y="53" width="18" height="16" rx="4"/><rect x="130" y="53" width="18" height="16" rx="4"/><rect x="151" y="53" width="18" height="16" rx="4"/><rect x="172" y="53" width="18" height="16" rx="4"/><rect x="193" y="53" width="18" height="16" rx="4"/><rect x="214" y="53" width="18" height="16" rx="4"/><rect x="235" y="53" width="55" height="16" rx="4"/>
            <rect x="9" y="73" width="27" height="16" rx="4"/><rect x="39" y="73" width="18" height="16" rx="4"/><rect x="60" y="73" width="18" height="16" rx="4"/><rect x="81" y="73" width="130" height="16" rx="4"/><rect x="214" y="73" width="18" height="16" rx="4"/><rect x="235" y="73" width="18" height="16" rx="4"/><rect x="256" y="73" width="18" height="16" rx="4"/><rect x="277" y="73" width="14" height="16" rx="4"/>
          ...
          <g fill="none" stroke="#fff" stroke-width="1.2" opacity=".3">
            <rect x="39" y="33" width="18" height="16" rx="4"/>
            <rect x="109" y="53" width="18" height="16" rx="4"/>
            <rect x="81" y="73" width="130" height="16" rx="4"/>
          </g>
        </svg>
        <span class="lbl" style="color:rgba(0,0,0,.35);font-size:9.5px;font-weight:700;letter-spacing:2.5px;text-transform:uppercase;margin-top:12px;transition:opacity .35s;white-space:nowrap;">KEYBOARD</span>
      </div>
      ...
      <div id="w-monitor" style="position:absolute;display:flex;flex-direction:column;align-items:center;z-index:3;transition:left .75s cubic-bezier(.65,0,.35,1),bottom .75s cubic-bezier(.65,0,.35,1);">
        <svg id="v-monitor" width="240" height="239" viewBox="0 0 320 318" style="transition:width .75s cubic-bezier(.65,0,.35,1),height .75s cubic-bezier(.65,0,.35,1);overflow:visible;)">
          <defs>
            ...
            <radialGradient id="scrHot" cx="50%" cy="46%" r="28%">
              <stop offset="0%" stop-color="#999" stop-opacity=".6"/>
              <stop offset="100%" stop-color="transparent"/>
            </radialGradient>
          </defs>
          <ellipse cx="160" cy="310" rx="58" ry="8" fill="#444"/>
          <rect x="140" y="258" width="40" height="56" rx="7" fill="#3a3a3a"/>
          <rect x="148" y="242" width="24" height="22" rx="5" fill="#2a2a2a"/>
          <rect x="2" y="2" width="316" height="240" rx="15" fill="#1a1a1a" stroke="#333" stroke-width="2"/>
          <rect x="10" y="10" width="300" height="224" rx="10" fill="#050505"/>
          <rect x="10" y="10" width="300" height="224" rx="10" fill="url(#scr)"/>
          <rect x="10" y="10" width="300" height="224" rx="10" fill="url(#scrHot)"/>
          <g fill="white" opacity=".2">
            <circle cx="42" cy="35" r="1.5"/><circle cx="98" cy="58" r="1.2"/><circle cx="158" cy="26" r="1.7"/>
            <circle cx="222" cy="44" r="1.3"/><circle cx="288" cy="32" r="1.4"/><circle cx="296" cy="80" r="1.1"/>
            <circle cx="26" cy="108" r="1.2"/><circle cx="298" cy="128" r="1.5"/><circle cx="252" cy="176" r="1.2"/>
            <circle cx="65" cy="185" r="1.3"/><circle cx="172" cy="212" r="1.1"/><circle cx="116" cy="200" r="1.4"/>
          ...
          <circle cx="160" cy="250" r="4" fill="#fff" opacity=".5"/>
        </svg>
        <span class="lbl" style="color:rgba(0,0,0,.35);font-size:9.5px;font-weight:700;letter-spacing:2.5px;text-transform:uppercase;margin-top:12px;transition:opacity .35s;white-space:nowrap;">MONITOR</span>
      </div>
      ...
      <div id="w-mouse" style="position:absolute;display:flex;flex-direction:column;align-items:center;z-index:2;transition:left .75s cubic-bezier(.65,0,.35,1),bottom .75s cubic-bezier(.65,0,.35,1);">
        <svg id="v-mouse" width="98" height="124" viewBox="0 0 120 165" style="transition:width .75s cubic-bezier(.65,0,.35,1),height .75s cubic-bezier(.65,0,.35,1);overflow:visible;)">
          ...
          <ellipse cx="60" cy="158" rx="32" ry="6" fill="rgba(255,255,255,.04)"/>
          <path d="M18,132 Q2,114 2,76 Q2,18 38,10 Q64,6 84,30 Q104,54 100,98 Q95,128 68,140 Q42,148 18,132Z" fill="url(#msebg)" stroke="#2a2a2a" stroke-width="1.5"/>
          <path d="M48,11 L48,100" stroke="#0a0a0a" stroke-width="3"/>
          <path d="M48,11 Q26,15 10,44 Q4,64 6,84 L48,84Z" fill="#222" opacity=".55"/>
          <rect x="40" y="36" width="16" height="36" rx="8" fill="#111" stroke="#fff" stroke-width="2"/>
          <rect x="43" y="41" width="10" height="5" rx="2.5" fill="#2a2a2a"/>
          <rect x="43" y="50" width="10" height="5" rx="2.5" fill="#2a2a2a"/>
          <rect x="43" y="59" width="10" height="5" rx="2.5" fill="#2a2a2a"/>
          <path d="M18,132 Q42,148 68,140 Q95,128 100,98" stroke="url(#mseedge)" stroke-width="5.5" fill="none" opacity=".7"/>
          <rect x="3" y="78" width="5" height="24" rx="2.5" fill="#222"/>
        </svg>
        <span class="lbl" style="color:rgba(0,0,0,.35);font-size:9.5px;font-weight:700;letter-spacing:2.5px;text-transform:uppercase;margin-top:12px;transition:opacity .35s;white-space:nowrap;">MOUSE</span>
      </div>
      ...
      <div id="w-tower" style="position:absolute;display:flex;flex-direction:column;align-items:center;z-index:2;transition:left .75s cubic-bezier(.65,0,.35,1),bottom .75s cubic-bezier(.65,0,.35,1);">
        <svg id="v-tower" width="150" height="278" viewBox="0 0 200 375" style="transition:width .75s cubic-bezier(.65,0,.35,1),height .75s cubic-bezier(.65,0,.35,1);overflow:visible;)">
          <defs>
            ...
            <linearGradient id="fanring" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#fff"/><stop offset="100%" stop-color="#444"/></linearGradient>
          </defs>
          <rect x="5" y="4" width="162" height="367" rx="11" fill="url(#twrbg)" stroke="#222" stroke-width="2"/>
          <rect x="14" y="16" width="118" height="343" rx="8" fill="#080808" stroke="#1a1a1a" stroke-width="1"/>
          <rect x="5" y="4" width="8" height="367" rx="4" fill="url(#twrside)"/>
          <circle cx="73" cy="90"  r="43" fill="#0d0d0d" stroke="#1a1a1a" stroke-width="1.5"/>
          <circle cx="73" cy="90"  r="38" fill="none" stroke="url(#fanring)" stroke-width="4.5" opacity=".85"/>
          <circle cx="73" cy="90"  r="26" fill="#080808"/>
          <circle cx="73" cy="90"  r="9"  fill="#1a1a1a"/>
          <circle cx="73" cy="90"  r="4.5" fill="#fff" opacity=".6"/>
          <g transform="translate(73,90)" fill="#111" stroke="#1e1e1e" stroke-width=".7">
            <path d="M0,-29 Q14,-15 0,-9 Q-14,-15 0,-29"/><path d="M29,0 Q15,14 9,0 Q15,-14 29,0"/>
            <path d="M0,29 Q-14,15 0,9 Q14,15 0,29"/><path d="M-29,0 Q-15,-14 -9,0 Q-15,14 -29,0"/>
          </g>
          <circle cx="73" cy="205" r="43" fill="#0d0d0d" stroke="#1a1a1a" stroke-width="1.5"/>
          <circle cx="73" cy="205" r="38" fill="none" stroke="url(#fanring)" stroke-width="4.5" opacity=".85"/>
          <circle cx="73" cy="205" r="26" fill="#080808"/>
          <circle cx="73" cy="205" r="9"  fill="#1a1a1a"/>
          <circle cx="73" cy="205" r="4.5" fill="#fff" opacity=".6"/>
          <g transform="translate(73,205)" fill="#111" stroke="#1e1e1e" stroke-width=".7">
            <path d="M0,-29 Q14,-15 0,-9 Q-14,-15 0,-29"/><path d="M29,0 Q15,14 9,0 Q15,-14 29,0"/>
            <path d="M0,29 Q-14,15 0,9 Q14,15 0,29"/><path d="M-29,0 Q-15,-14 -9,0 Q-15,14 -29,0"/>
          </g>
          <circle cx="73" cy="318" r="38" fill="#0d0d0d" stroke="#1a1a1a" stroke-width="1.5"/>
          <circle cx="73" cy="318" r="33" fill="none" stroke="url(#fanring)" stroke-width="4" opacity=".85"/>
          <circle cx="73" cy="318" r="22" fill="#080808"/>
          <circle cx="73" cy="318" r="8"  fill="#1a1a1a"/>
          <circle cx="73" cy="318" r="4"  fill="#fff" opacity=".55"/>
          <g transform="translate(73,318)" fill="#111" stroke="#1e1e1e" stroke-width=".7">
            <path d="M0,-24 Q12,-13 0,-8 Q-12,-13 0,-24"/><path d="M24,0 Q13,12 8,0 Q13,-12 24,0"/>
            <path d="M0,24 Q-12,13 0,8 Q12,13 0,24"/><path d="M-24,0 Q-13,-12 -8,0 Q-13,12 -24,0"/>
          </g>
          <rect x="140" y="16" width="27" height="343" rx="5" fill="#0f0f0f"/>
          <circle cx="153" cy="40" r="10" fill="#1a1a1a" stroke="#fff" stroke-width="2.2"/>
          <circle cx="153" cy="40" r="5" fill="#fff" opacity=".6"/>
          <rect x="144" y="60" width="18" height="11" rx="3" fill="#080808" stroke="#222" stroke-width=".8"/>
          <rect x="144" y="77" width="18" height="11" rx="3" fill="#080808" stroke="#222" stroke-width=".8"/>
          <rect x="144" y="98" width="18" height="14" rx="3" fill="#080808" stroke="#222" stroke-width=".8"/>
          <rect x="144" y="118" width="18" height="14" rx="3" fill="#080808" stroke="#222" stroke-width=".8"/>
          <rect x="144" y="142" width="18" height="50" rx="3" fill="#080808" stroke="#222" stroke-width=".8"/>
          <rect x="144" y="200" width="18" height="11" rx="3" fill="#1a1a1a"/>
          <rect x="144" y="218" width="18" height="11" rx="3" fill="#1a1a1a"/>
        </svg>
        <span class="lbl" style="color:rgba(0,0,0,.35);font-size:9.5px;font-weight:700;letter-spacing:2.5px;text-transform:uppercase;margin-top:12px;transition:opacity .35s;white-space:nowrap;">PC TOWER</span>
      </div>
